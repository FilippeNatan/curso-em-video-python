...
nomes = []; idades = []; sexo = []; numPessoa = 2; homemMaiorIdade = 0; homemMaiorIdadeNome = 'Ninguém'; mulheresMenos20Anos = 0
...
for contador in range(numPessoa):
    ...
    if (sexo[contador] == 'm' and idades[contador] > homemMaiorIdade):
        homemMaiorIdade = idades[contador]
        homemMaiorIdadeNome = nomes[contador]

    if(sexo[contador] == 'f' and idades[contador] < 20):
